...
Element Plus also provides a Vue component [ConfigProvider](/component/config-provider)
...
Full documentation refer to: [ConfigProvider](/component/config-provider)
